...
image: "../static/recommender-system.png"
format:
  html:
    code-fold: false
...
:::{.column-page}
![The Demo](../static/session-based-retriever-demo-v2.gif){.lightbox}
:::
...
:::{.column-page}
![](../static/recommender-system.png){.lightbox}
:::
...
:::{.column-page}
![The signals we can leverage to deliver better recommenations](../static/l2-data-signals.excalidraw.png){.lightbox}
:::
