...
Let's illustrate this process with a concrete example to see how popularity-based negative sampling works in practice.

Starting with a simple user-item interaction dataset:
...
### Step 1: Item Popularity Calculation

**Item Popularity (Interaction Frequency)**
...
### Step 2: Negative Candidates per User
...
### Step 3: Popularity-Weighted Negative Sampling
...
### Final Result: Original + Generated Negatives
