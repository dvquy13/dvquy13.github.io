...
If you're familiar with RecSys and just want to see the code, here it is: [github.com/dvquy13/real-time-seq-recsys](https://github.com/dvquy13/real-time-seq-recsys).
:::
...
In **Chapter 2**, we'll get our hands dirty with the data:

- Exploring the Amazon product dataset
- Building features for sequence models  
- Setting up preprocessing pipelines
- Creating proper train/validation/test splits for temporal data

The key to good recommendations is understanding your data deeply. That's exactly what we'll tackle next.

Ready to dive in? Let's continue to Chapter 2 where we'll explore the data that powers our recommendation engine! 🚀
...
> Quy, Dinh. (May 2025). {{< meta title >}}. {{< var website_url >}}. https://{{< var website_url >}}/projects/real-time-seq-recsys/c1/. 
