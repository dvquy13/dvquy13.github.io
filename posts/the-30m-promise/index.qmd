...
There's a small issue: Tracking time is still in my blood though. I've always been the person who blocks out my week, who wants to see where my hours went. Abandoning that entirely felt like losing a limb. So I kept using Google Calendar—just without the weekly targets. I'd block time for a session, start working, and if I wanted to keep going, I'd drag the end time forward.
...
Here's what actually happens once you sit down.
...
There's another beautiful benefit in this act. The next time you sit down for 30 minutes, you don't need to figure out what to work on. The questions are already there, waiting to run over your mind. By no time you're so back into the context.
